...
| API | Description | Authentication | HTTPS |
|-----|-------------|------|-------|
| [Open Library](https://openlibrary.org/developers/api) | Book Database | No | Yes |
...
| API | Description | Authentication | HTTPS |
|-----|-------------|------|-------|
| [BARCODE LOOKUP](https://www.barcodelookup.com/api#test-account) | Product Lookup | API Key | Yes |
